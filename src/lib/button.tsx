...
export function buttonClasses(
  ...
  return cn(
    'select-none rounded-md px-4 py-2 text-center font-medium transition will-change-transform focus-visible:outline-none focus-visible:ring focus-visible:ring-white active:scale-95 disabled:cursor-not-allowed disabled:!opacity-50',
    primary
